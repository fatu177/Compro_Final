        ...
        <div class="card-body">
            <form action="{{ route('profile.store') }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control" type="text" name="address" placeholder="Masukan address Pekerjaan Anda"> </textarea>
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control" type="text" name="linkedin" placeholder="Masukan LinkedIn Anda"> </textarea>
                </div>
                <div class="form-group mb-3">
                    <label for="">twitter</label>
                    <textarea class="form-control" type="text" name="twitter" placeholder="Masukan twitter Anda"> </textarea>
                </div>
                <div class="form-group mb-3">
                    <label for="">Facebook</label>
                    <textarea class="form-control" type="text" name="facebook" placeholder="Masukan Facebook Anda"> </textarea>
                </div>
                <div class="form-group mb-3">
                    <label for="">Instagram</label>
                    <textarea class="form-control" type="text" name="instagram" placeholder="Masukan Instagram Anda"> </textarea>
                </div>
